...
Hay que tener en cuenta que Excel no nos define en la tabla el tipo de intervalo que hemos obtenido. Pero sabemos que la fórmula de cálculo es tal que la frecuencia indicada corresponde a `<=` que el valor de clase. Para evitar confusiones, es útil añadir una columna con los intervalos especificados de forma manual.

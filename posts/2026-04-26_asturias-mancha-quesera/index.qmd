...
ggplot() +
  ...
  geom_sf(data = paises_eu,
          ...
          linewidth = 0.5) +
  annotate("label",
           x = asturias_coords[1], y = asturias_coords[2] + 100000,
           label = paste0("Asturias\n", scales::comma(round(
             dop_nuts2 %>% filter(nuts2_code == "ES12") %>% pull(ton_dop)
           )), " t"),
           size = 2.2, color = "#D55E00", fill = "white",
  ...
  labs(
    title    = "Producción de queso DOP/IGP por región europea",
    subtitle = "España, Francia, Italia, Suiza y Grecia · datos 2021-2023 · 15 principales regiones etiquetadas",
    caption  = "Producción distribuida equitativamente entre regiones NUTS2 del ámbito geográfico de cada DOP

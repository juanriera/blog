...
nocite: |
  ...
  @wiki-1-2025, @mapa-1-2023, @mapa-2-2023, @mapa-3-2023, @sek2025,
...
Aunque la producción de queso en Asturias es importante, no es superior a la de muchas otras zonas de Europa, comparando con países completos. Si buscásemos zonas queseras importantes de Europa, seguramente la reducción de la superficie considerada haría subir las ratios para estas zonas de alta producción.  Por ello no parece justificado denominar a Asturias ***la mayor mancha quesera de Europa***, aunque es necesario mejorar la información regional europea para validar esta conclusión. 

Por otra parte, en el total de queso fabricado en Asturias hay una cantidad importante de productos que no tienen una vinculación con la región más allá de estar fabricados en ella: es el caso de mozzarellas, quesos fundidos y otros, que la última edición del **Catálogo general de los quesos elaborados en Asturias** @vadequesum2026 ya ha excluido del catálogo.

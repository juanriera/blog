...
El gráfico muestra la relación entre el índice de humedad en base al extracto magro (HFD) y el pH en un queso de pasta blanda tipo Camembert, diferenciando los datos según la época del año en que se elaboró el queso. Es un ejemplo de cómo las anotaciones pueden ayudr a la comprensión de los datos representados.
...
Esta variación estacional refleja las diferencias en el manejo de la tecnología, con consecuencias directas sobre la textura y la evolución del queso durante la maduración.

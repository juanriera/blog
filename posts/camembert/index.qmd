...
El gráfico muestra la relación entre el índice de humedad en base al extracto magro (HFD) y el pH en un queso de pasta blanda tipo Camembert, diferenciando los datos según la época del año en que se elaboró el queso. 
...
Las elipses de confianza al 75% permiten visualizar de un vistazo cómo se agrupan ambas temporadas: en verano el queso tiende a presentar mayor HFD con pH más bajo, mientras que en invierno el comportamiento se desplaza hacia valores de HFD menores y pH algo más elevado. 

Esta variación estacional refleja las diferencias en la composición de la leche y en la dinámica de acidificación según la época, y tiene consecuencias directas sobre la textura y la evolución del queso durante la maduración.

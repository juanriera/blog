...
En el mundo de la empresa, la utilización de las hojas de cálculo, sobre todo de Microsoft Excel, está mucho más extendida que la de lenguajes como R o python, y por eso siempre que enseño métodos de análisis de datos en R, intento presentar de forma simultánea cómo se realizarían en Excel, comparando ventajas e inconvenientes ambas herramientas. Así, aquellas personas que no están formadas en R, pero sí tienen experiencia en Excel, pueden imaginar un camino de aprendizaje hacia la nueva herramienta, o simplemente adoptar la técnica con la hoja de cálculo conocida.
...
Este es mi gráfico XY final:

![](excel-graf-XY-final.png)

Jugando con el factor de multiplicación en las fórmulas de las columnas calculadas, podemos aumentar el efecto de `jitter` en caso de que el solapamiento sea excesivo. Al recalcular la tabla dinámica podremos ver el efecto producido y decidir si es bajo, excesivo, o es el que queremos.

...
Modificando con el factor de multiplicación en las fórmulas de las columnas calculadas, podemos aumentar el efecto de `jitter` en caso de que el solapamiento sea excesivo. Al recalcular la tabla dinámica podremos ver el efecto producido y decidir si es bajo, excesivo, o es el que queremos.

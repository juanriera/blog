...
La función `cut_interval()` también permite definir la amplitud del intervalo mediante el parámetro `length=`, de manera alternativa al número de clases que definimos con `n=`

...
## Cómo hacerlo en R
Adjunto el código R para hacer un gráfico equivalente al anterior en R. El posicionamiento de las imágenes es más engorroso; hay que detallar las coordenadas de cada imagen. El resultado definitivo sólo se consigue por ensayo y error. al no ser posible la edición visual de la que dispone Excel.

...
scat <-
  ...
  annotation_custom(i3, ymin = 59.7, ymax = 71.7, xmin = 153.8, xmax =166.8) +
...
+--------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Inconvenientes** | -   La preparación del gráfico es un poco engorrosa, debido a que las tablas dinámicas no ofrecen gráficos de dispersión                              | -   Para hacer un formato complejo, es necesario conocer bastante en detalle la codificación en R y en `ggplot`                                                                                                                     |

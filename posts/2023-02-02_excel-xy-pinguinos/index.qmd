...
Esta es la fórmula corregida: `=IF(ISBLANK(Tabla1[bill_length_mm]);BLANK();Tabla1[bill_length_mm]+CALCULATE(RAND()/100))` que devuelve un valor en blanco cuando el valor original es un valor en blanco.

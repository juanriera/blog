...
Para hacer la curva normal en `ggplot`, desde  -4 $\sigma$ hasta +4 $\sigma$, usamos este código, en el que creamos directamente el *dataframe* que vamos a dibujar dentro de la propia instrucción `ggplot`:
...
Ymax <- max(dnorm(Xmedia, Xmedia, Xdt))
